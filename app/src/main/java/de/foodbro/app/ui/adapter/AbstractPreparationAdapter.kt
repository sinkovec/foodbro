...
import de.foodbro.app.util.callbacks.PreparationDiffCallback

abstract class AbstractPreparationAdapter<T : ViewDataBinding> : AbstractAdapter<T, PreparationStep>(
    PreparationDiffCallback()
) {
